class NationSerializer < ActiveModel::Serializer
  ...
  def large_image
    ...
    ActionController::Base.helpers.asset_path "images/nations/large/nation_#{object.base_id}.png"
  end

  def small_image
    ActionController::Base.helpers.asset_path "images/nations/normal/nation_#{object.base_id}.png"
  end
end
